...
class BuscarClientePorIdUseCaseImplTest {
    ...
    @InjectMocks
    BuscarClientePorIdUseCaseImpl buscarClientePorIdUseCase;
    ...
    void deveBuscarClientePorId() {
        ...
        Mockito.when(clienteDomainRepository.buscarClientePorIdExterno(clienteDomainEntity)).thenReturn(clienteDomainEntity);

        // Act
        final var clienteResponse = buscarClientePorIdUseCase.execute(clienteDomainEntity);
